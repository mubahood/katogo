...
class MunoCrawlSession extends Model
{
    protected $fillable = [
        'status', 'category_id', 'category_name',
        'pages_fetched', 'movies_discovered', 'movies_processed',
        'movies_new', 'movies_updated', 'movies_skipped', 'movies_failed',
        'series_new', 'triggered_by', 'notes', 'started_at', 'ended_at',
    ];
    ...
    {
        return $this->hasMany(MunoCrawlLog::class, 'session_id');
    }
