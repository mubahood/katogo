...
class ApiController extends BaseController
{
    ...
    public function profile_wizard_contact(Request $r)
    {
        ...
        $phoneOwner = User::where('phone_number', $normalizedPhone)
            ->where('id', '!=', $u->id)
            ->first();
        if ($phoneOwner != null) {
            return $this->error('That phone number is already linked to another account.');
        }
        ...
        if (!empty($email)) {
            ...
            $emailOwner = User::where('email', $email)
                ...
                ->first();
            if ($emailOwner != null) {
                return $this->error('That email address is already linked to another account.');
            }
    ...
    public function profile_wizard_photo(Request $r)
    {
        ...
        if ($skipPhoto) {
            ...
            if (empty($uploaded)) {
                return $this->error('Failed to upload profile photo.');
            }
